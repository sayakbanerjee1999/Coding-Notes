# Doubly Linked List - Because we need to delete from anywhere (Nice to keep a Next; Prev Pointers)
# Sorted List Data Structure - Keeps the nodes in increasing order of values Max at the end (index -1) sorted by their values. 
# Enables MaxPOP and PeekMax operations
