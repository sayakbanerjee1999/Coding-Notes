...
# Therefore, the previous function's interval is:
# [prevTime, timestamp)
# So:
# timestamp - prevTime
...
# An end timestamp marks the last time unit occupied by the function.
# Therefore, the function's interval is:
# [prevTime, timestamp]
# So:
# timestamp - prevTime + 1

# That's the entire reason for the +1.
